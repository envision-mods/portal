...
function getIdLayoutPosition__callback(XMLDoc)
{
	...
	cellColumns.innerHTML = '<div class="floatleft"><a href="javascript:void(0);" onclick="javascript:columnUp(this.parentNode.parentNode.parentNode);" onfocus="if(this.blur)this.blur();"><img src="' + smf_default_theme_url + '/images/admin/ep_up.gif" style="width: 12px; height: 11px;" border="0" /></a> <a href="javascript:void(0);" onclick="javascript:columnDown(this.parentNode.parentNode.parentNode);" onfocus="if(this.blur)this.blur();"><img src="' + smf_default_theme_url + '/images/admin/ep_down.gif" style="width: 12px; height: 11px;" border="0" /></a></div><span class="ep_edit_column" id="column_' + columnIdVal + '">' + columnString + ' ' + columnNum + '</span>';
...
{
	addHiddenElement("epFlayouts", rowPos, "rowPos");
	addHiddenElement("epFlayouts", colPos, "colPos");
	addHiddenElement("epFlayouts", layoutPos, "layoutPos");
	addHiddenElement("epFlayouts", newColumns, "newColumns");
	addHiddenElement("epFlayouts", totalColumns, "totalColumns");
	addHiddenElement("epFlayouts", totalRows, "totalRows");
	...
	while(i--)
	{
		...
		{
			addHiddenElement("epFlayouts", rId.replace("row_", ""), "rId[]");
			cId = rId;
		}

		if (rId.indexOf("tr_") > -1)
			addHiddenElement("epFlayouts", rId.replace("tr_", ""), "cId[]");
	}
}