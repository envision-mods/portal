	...
	if (is_array($params))
	{
		...
		if (!$user_info['is_guest'])
		{
			...
			<form name="post_shoutbox', $unique_id, '" id="post_shoutbox', $unique_id, '" method="post" action="" accept-charset="', $context['character_set'], '">
				...
				<br class="clear" />
				<input name="shout_submit" value="', $txt['ep_shoutbox_shout'], '" class="button_submit" type="submit" tabindex="', $context['tabindex']++, '" />
					<img src="', $context['ep_module_image_url'], 'shoutbox/emoticon_smile.png" alt="" title="', $txt['ep_shoutbox_emoticons'], '" class="hand" id="toggle_smileys_div', $unique_id, '" />
					<img src="', $context['ep_module_image_url'], 'shoutbox/font.png" alt="" title="', $txt['ep_shoutbox_fonts'], '" class="hand" id="toggle_font_styles_div', $unique_id, '" />
					<img src="', $context['ep_module_image_url'], 'shoutbox/clock.png" alt="" title="', $txt['ep_shoutbox_history'], '" class="hand" id="toggle_history_div', $unique_id, '" />
...
function ep_shoutbox_history($params)
{
	...
	$listOptions = array(
		...
		'no_items_label' => $txt['ep_shoutbox_no_msg'],
		'get_items' => array(
		...
		'columns' => array(
			...
			'display_name' => array(
				'header' => array(
					'value' => $txt['ep_shoutbox_display_name'],
				),
				'data' => array(
			...
			'poster_time' => array(
				'header' => array(
					'value' => $txt['ep_shoutbox_poster_time'],
				),
				'data' => array(
					'style' => 'text-align: center;',
					'function' => create_function('$rowData', '
